    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    var user = new Admin { UserName = model.Email, Email = model.Email, FullName = model.Fullname};
                ...
                {
                    var user = new Staff { UserName = model.Email, Email = model.Email, FullName = model.Fullname };
                    var result = await UserManager.CreateAsync(user, model.Password);
                ...
                {
                    var user = new Trainer { UserName = model.Email, Email = model.Email, FullName = model.Fullname };
                    var result = await UserManager.CreateAsync(user, model.Password);
